...
interface DropzoneProps {
  setFilesCallback: (files: FileWithPath[]) => void;
}

export default function DropzoneButton({ setFilesCallback }: DropzoneProps) {
      ...
      >
        <div style={{ pointerEvents: "none" }}>
          ...
          <Text align="center" size="sm" mt="xs" color="dimmed">
            Drag&apos;n&apos;drop files here to upload. We accept image and{" "}
